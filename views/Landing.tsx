    ...
    >
      ...
      <div className="py-16 md:py-24 relative z-20 bg-gradient-to-b from-[#090014] to-[#120024] overflow-hidden">
          ...
          <div className="w-full overflow-hidden relative group">
              ...
              {/* Scrolling Track - Using fetched showcaseImages */}
              <div className="flex w-max animate-marquee pause-on-hover gap-6 px-6">
                   ...
                   {/* Render Set 2 (for seamless loop) */}
                   {showcaseImages.map((item, i) => (
           ...
           <div className="max-w-7xl mx-auto px-6">
               <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                   ...
                   <div className="flex flex-col items-center md:items-end space-y-4">
                       ...
                       <span className="text-slate-400 text-sm">Email: dmpaidev@gmail.com</span>
                       <span className="text-slate-400 text-sm">Hotline: 0824280497</span>
                   </div>
               </div>
               <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                   <p className="text-xs text-slate-600">© 2026 DMP AI Photo Studio. All rights reserved.</p>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-fade-in">
              <div className="w-full max-w-md bg-[#090014] border-2 border-audi-pink rounded-3xl p-8 relative shadow-[0_0_50px_rgba(255,0,153,0.3)]">
                  ...
                  <div className="mb-6">
                      <button 
                        onClick={onEnter} 
                        className="w-full py-3 bg-white text-black font-bold rounded-xl flex items-center justify-center gap-3 hover:bg-slate-200 transition-colors"
                      >
