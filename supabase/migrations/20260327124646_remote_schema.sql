...
drop policy "Public insert visits" on "public"."app_visits";

drop policy "Public read packages" on "public"."credit_packages";

drop policy "Public read generated showcase" on "public"."generated_images";

drop policy "Public read giftcodes" on "public"."gift_codes";

drop policy "Public read promotions" on "public"."promotions";

drop policy "Public read styles" on "public"."style_presets";

drop policy "Public read settings" on "public"."system_settings";

drop policy "Public read users" on "public"."users";

revoke delete on table "public"."gift_code_usages" from "authenticated";

revoke insert on table "public"."gift_code_usages" from "authenticated";

revoke update on table "public"."gift_code_usages" from "authenticated";
