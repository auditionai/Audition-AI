...
const AITool: React.FC = () => {
    ...
    const BgRemoverTool = (
      <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:min-h-[60vh]">
        {/* Left Column: Upload */}
        <div className="flex flex-col">
          <h3 className="font-semibold mb-3 text-lg flex-shrink-0">1. Tải ảnh lên</h3>
          <div className="p-4 bg-black/20 rounded-lg border border-white/10 flex-grow flex flex-col">
            ...
            <button onClick={handleProcessBackgrounds} disabled={isProcessing || imagesForBgRemoval.length === 0} className="w-full mt-4 py-3 font-bold text-lg text-white bg-gradient-to-r from-pink-500 to-fuchsia-600 rounded-full flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0">
        ...
        <div className="flex flex-col">
          <h3 className="font-semibold mb-3 text-lg flex-shrink-0">2. Kết quả</h3>
          <div className="bg-black/20 rounded-lg border border-white/10 flex-grow p-4 flex flex-col">
            {processedImages.length === 0 && !isProcessing ? (
              <div className="flex flex-col items-center justify-center h-full text-gray-500 text-center flex-grow">
