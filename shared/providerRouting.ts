...
export const GENERATION_PROVIDER_ROUTE_OPTIONS: Array<{
  ...
  { key: 'image_group_6', label: 'Tạo ảnh nhóm 6', description: 'Sáu nhân vật; mặc định dùng Gommo.' },
  { key: 'image_group_7', label: 'Tạo ảnh nhóm 7', description: 'Bảy nhân vật; mặc định dùng Gommo.' },
  { key: 'image_group_8', label: 'Tạo ảnh nhóm 8', description: 'Tám nhân vật, không dùng ảnh mẫu; mặc định dùng Gommo.' },
