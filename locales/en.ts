export const en = {
  ...
  luckyWheel: {
    ...
    adminGallery: {
      ...
      empty: {
        title: 'Gallery Empty',
        description: 'No public creations shared by users yet.',
      },
      deleteSuccess: 'Removed creation from public gallery!',
      error: {
    ...
    settings: {
      ...
      referral: {
        ...
        copy: 'Copy',
        copied: 'Copied',
        desc: 'Share this code with your friends. When they sign up and enter the code, both of you receive',
        bonus: '5 Diamonds',
      },
      xpGuide: {
