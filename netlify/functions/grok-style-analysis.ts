...
export const handler: Handler = async (event) => {
  ...
  try {
    ...
    const analysis = await claudeText('Analyze this image visual style for a 3D character generator. Return concise comma-separated keywords covering lighting, texture, rendering-engine feel, and artistic mood.', [image], 300, { timeoutMs: 30_000 });
