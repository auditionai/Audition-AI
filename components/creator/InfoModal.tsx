...
const InfoModalContent: React.FC<{ contentKey: InfoKey }> = ({ contentKey }) => {
    switch (contentKey) {
        case 'terms':
            return (
                <div className="text-sm text-skin-muted space-y-3 custom-scrollbar pr-2 max-h-[60vh] overflow-y-auto">
                    <p className="font-bold text-skin-base">1. "Kim Cương" là gì?</p>
                    ...
                    <p className="font-bold text-skin-base mt-4">2. Thời hạn và cách thức sử dụng "Kim Cương"</p>
                    ...
                    <p className="font-bold text-skin-base mt-4">3. Tiêu chuẩn giá</p>
                    ...
                    <p className="font-bold text-skin-base mt-4">4. Thứ tự sử dụng</p>
                    ...
                    <p className="font-bold text-skin-base mt-4">5. "Kim Cương" được sử dụng cho việc gì?</p>
                    ...
                    <p className="font-bold text-skin-base mt-4">6. Làm thế nào để kiểm tra số dư và chi tiết sử dụng?</p>
        ...
        case 'policy':
            return (
                <div className="text-sm text-skin-muted space-y-3 custom-scrollbar pr-2 max-h-[60vh] overflow-y-auto">
                    <p className="font-bold text-skin-base">1. Thu thập thông tin</p>
                    ...
                    <p className="font-bold text-skin-base">2. Sử dụng thông tin</p>
                    ...
                    <p className="font-bold text-skin-base">3. Chia sẻ thông tin</p>
                    ...
                    <p className="font-bold text-skin-base">4. Bảo mật</p>
                ...
                <div className="text-sm text-skin-muted space-y-4">
                    ...
                    <div className="space-y-3">
                        <div className="bg-skin-fill-secondary p-3 rounded-lg">
                            <p className="text-skin-muted">Người sáng lập & Phát triển</p>
                            <p className="font-semibold text-skin-base">Nguyễn Quốc Cường</p>
                        </div>
                        <div className="bg-skin-fill-secondary p-3 rounded-lg">
                            <p className="text-skin-muted">Số điện thoại</p>
                            <p className="font-semibold text-skin-base">0824.280.497</p>
                        </div>
                        <div className="bg-skin-fill-secondary p-3 rounded-lg">
                            <p className="text-skin-muted">Email</p>
                            <p className="font-semibold text-skin-base">admin@auditionai.io.vn</p>
                        </div>
                         <div className="bg-skin-fill-secondary p-3 rounded-lg">
                            <p className="text-skin-muted">Facebook</p>
                            <a href="https://www.facebook.com/iam.cody.real/" target="_blank" rel="noopener noreferrer" className="font-semibold text-skin-accent hover:underline break-all">https://www.facebook.com/iam.cody.real/</a>
                        </div>
                    </div>
                </div>
            );
