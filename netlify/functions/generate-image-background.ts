...
const handler: Handler = async (event: HandlerEvent) => {
    ...
    try {
        ...
        if (referenceImage) {
            ...
            // Should be handled by frontend, but fallback safety
        ...
        // Changed from Promise.all to sequential loop to isolate errors
        ...
        if (!removeWatermark) {
            // Local file load watermark service
