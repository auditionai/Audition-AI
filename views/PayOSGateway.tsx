...
export const PayOSGateway: React.FC<PayOSGatewayProps> = ({ transaction, onSuccess, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-black/20 backdrop-blur-md flex items-center justify-center font-sans text-slate-800 animate-fade-in overflow-y-auto">
