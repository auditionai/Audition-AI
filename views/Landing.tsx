...
export const Landing: React.FC<LandingProps> = ({ onEnter }) => {
  ...
  const handleGoogleLogin = async () => {
      ...
      if (error) {
          ...
          notify(error?.message || 'Khong the ket noi voi Google.', 'error');
              ...
              <div className="w-full max-w-md bg-[#090014] border-2 border-audi-pink rounded-3xl p-8 relative shadow-[0_0_50px_rgba(255,0,153,0.3)]">
                  ...
                  <div className="space-y-4">
                      ...
                      <button 
                          ...
                          disabled={isAuthLoading}
                          className="w-full py-3 bg-white hover:bg-slate-200 text-black font-bold rounded-xl flex items-center justify-center gap-3 transition-colors shadow-lg group disabled:opacity-70 disabled:cursor-not-allowed"
                      >
