...
export const SHOP_EXCLUSIVE_COSMETICS: CosmeticItem[] = [
    ...
    { id: 'shop-frame-04', type: 'frame', name: 'Hào Quang Thần Thánh', rarity: 'legendary', cssClass: 'shop-frame-04', price: 300 },
    { id: 'shop-frame-05', type: 'frame', name: 'Vòng Tròn Độc Dược', rarity: 'rare', cssClass: 'shop-frame-05', price: 80 },
    { id: 'shop-frame-06', type: 'frame', name: 'Bong Bóng Nước', rarity: 'rare', cssClass: 'shop-frame-06', price: 80 },
    { id: 'shop-frame-07', type: 'frame', name: 'Vàng Ròng 24K', rarity: 'legendary', cssClass: 'shop-frame-07', price: 500 },
    { id: 'shop-frame-08', type: 'frame', name: 'Nhịp Tim Yêu Thương', rarity: 'epic', cssClass: 'shop-frame-08', price: 200 },
    { id: 'shop-frame-09', type: 'frame', name: 'Hư Không Tím', rarity: 'epic', cssClass: 'shop-frame-09', price: 200 },
    { id: 'shop-frame-10', type: 'frame', name: 'Vòng Xoay 7 Sắc', rarity: 'mythic', cssClass: 'shop-frame-10', price: 1000 },
    { id: 'shop-frame-11', type: 'frame', name: 'Vòng Tròn Công Nghệ', rarity: 'epic', cssClass: 'shop-frame-11', price: 250 },
    { id: 'shop-frame-12', type: 'frame', name: 'Dung Nham Nóng Chảy', rarity: 'legendary', cssClass: 'shop-frame-12', price: 400 },
    { id: 'shop-frame-13', type: 'frame', name: 'Băng Giá Vĩnh Cửu', rarity: 'epic', cssClass: 'shop-frame-13', price: 250 },
    { id: 'shop-frame-14', type: 'frame', name: 'Bí Ẩn Huyền Bí', rarity: 'epic', cssClass: 'shop-frame-14', price: 200 },
    { id: 'shop-frame-15', type: 'frame', name: 'Thiên Nhiên Hoang Dã', rarity: 'rare', cssClass: 'shop-frame-15', price: 100 },
    { id: 'shop-frame-16', type: 'frame', name: 'Idol Tỏa Sáng', rarity: 'legendary', cssClass: 'shop-frame-16', price: 450 },
    { id: 'shop-frame-17', type: 'frame', name: 'Bóng Ma', rarity: 'rare', cssClass: 'shop-frame-17', price: 120 },
    { id: 'shop-frame-18', type: 'frame', name: 'Sith Lord', rarity: 'mythic', cssClass: 'shop-frame-18', price: 1200 },
