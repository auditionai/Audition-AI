...
const normalizeSampleVision = (raw: any): SampleVisionAnalysis => ({
  ...
  facialOrientation: typeof raw?.facialOrientation === 'string' ? raw.facialOrientation.trim() : undefined,
  gazeDirection: typeof raw?.gazeDirection === 'string' ? raw.gazeDirection.trim() : undefined,
  ...
  lightingDirection: typeof raw?.lightingDirection === 'string' ? raw.lightingDirection.trim() : undefined,
  colorPalette: typeof raw?.colorPalette === 'string' ? raw.colorPalette.trim() : undefined,
  contrastAndExposure: typeof raw?.contrastAndExposure === 'string' ? raw.contrastAndExposure.trim() : undefined,
  ...
  propLayout: typeof raw?.propLayout === 'string' ? raw.propLayout.trim() : undefined,
