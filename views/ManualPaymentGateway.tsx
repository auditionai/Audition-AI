        ...
        <div className="w-full max-w-5xl bg-white shadow-2xl rounded-xl overflow-hidden flex flex-col md:flex-row min-h-[600px] m-4">
            <div className="w-full md:w-1/2 p-8 md:p-12 bg-white flex flex-col relative border-r border-slate-100">
                <div className="flex items-center gap-2 mb-8">
                    <div className="font-bold text-2xl text-emerald-600 flex items-center gap-1">
                        SePay <span className="text-xs bg-emerald-600 text-white px-1 py-0.5 rounded ml-1">BANK QR</span>
                    </div>
                </div>

                <div className="flex-1">
                    <div className="mb-6">
                        <p className="text-sm text-slate-500 font-medium uppercase tracking-wider mb-1">Don hang het han sau</p>
                    ...
                    <div className="space-y-6">
                        <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
                            <div className="flex justify-between items-center mb-2">
                                <span className="text-sm text-slate-500">Ma don hang</span>
                        ...
                        <div className="space-y-4 text-sm">
                            <div className="flex justify-between">
                                <span className="text-slate-500">Nguoi thu huong</span>
                            ...
                            <div className="flex justify-between">
                                <span className="text-slate-500">So tai khoan</span>
                                <div className="flex items-center gap-2">
                                    <span className="font-bold">{BANK_INFO.accountNo}</span>
                                    <Icons.Copy className="w-3 h-3 text-slate-400 cursor-pointer hover:text-emerald-600" />
                                </div>
                            </div>
                            <div className="flex justify-between items-start">
                                <span className="text-slate-500">Noi dung CK</span>
                ...
                >
                    <Icons.ArrowUp className="w-4 h-4 -rotate-90" /> Huy thanh toan va quay lai
                </button>
            </div>
            ...
            <div className="w-full md:w-1/2 bg-[#f8faff] p-8 md:p-12 flex flex-col items-center justify-center relative">
                ...
                <div className="text-center mb-8">
                    <h3 className="text-xl font-bold text-slate-800 mb-2">Quet ma QR de thanh toan</h3>
                    <p className="text-sm text-slate-500">Su dung ung dung ngan hang hoac vi dien tu</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] mb-8 relative group">
                     {isPaid ? (
                         <div className="w-64 h-64 flex flex-col items-center justify-center bg-green-50 rounded-xl border-2 border-green-500">
                             ...
                             <span className="font-bold text-green-600">Da ghi nhan!</span>
                             <span className="text-xs text-green-500">He thong dang doi soat tu dong...</span>
                         </div>
                     ) : (
                        <>
                ...
                {!isPaid && (
                    <div className="w-full max-w-xs space-y-3">
                        <button
                            ...
                            className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-lg shadow-lg shadow-emerald-500/30 transition-all active:scale-95"
                        >
                            Da thanh toan
                        </button>
                        <p className="text-xs text-center text-slate-400">
                            Nhap chinh xac noi dung chuyen khoan <b className="text-slate-600">{transaction.code}</b> de he thong doi soat tu dong.
                        </p>
                    </div>
                )}
            </div>
