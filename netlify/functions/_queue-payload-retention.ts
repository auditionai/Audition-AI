...
export const compactTerminalQueuePayload = (value: unknown): QueuePayload => {
  ...
  return Object.fromEntries(Object.entries({
    ...
    __smartProviderFallbackEnabled: keepValue(payload, '__smartProviderFallbackEnabled'),
    __tstFallbackTriedServers: keepValue(payload, '__tstFallbackTriedServers'),
    __providerFallbackHistory: keepValue(payload, '__providerFallbackHistory'),
