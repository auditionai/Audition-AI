...
const FaqItem: React.FC<{ item: typeof FAQ_DATA[0]; isOpen: boolean; onClick: () => void }> = ({ item, isOpen, onClick }) => (
  <div className="border-b border-white/10">
    <button onClick={onClick} className="w-full text-left py-6 px-8 flex justify-between items-center">
    ...
    <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? 'max-h-96' : 'max-h-0'}`}>
      <p className="px-8 pb-6 text-gray-400">{item.answer}</p>
    </div>
  </div>
);
  ...
  return (
    <div className="py-12 sm:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto landing-card overflow-hidden">
