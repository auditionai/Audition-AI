  ...
  return (
    <div className="min-h-screen bg-[#F6F6F8] pb-10 dark:bg-[#09090B]">
      ...
      <div className="space-y-4 px-4 py-4">
        ...
        {activeTab === 'queue' && (
          <Card>
            <div className="mb-4 flex items-start justify-between gap-3"><div className="flex items-start gap-3"><div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gray-100 dark:bg-zinc-800"><Activity className="h-5 w-5 text-gray-700 dark:text-white" /></div><div><h2 className="text-base font-black text-gray-900 dark:text-white">Theo dõi hàng đợi</h2><p className="mt-1 text-xs text-gray-500 dark:text-zinc-400">Theo dõi job ảnh/video và debug nhanh</p></div></div><button onClick={reconcileQueue} className="rounded-full bg-gray-100 px-3 py-1.5 text-[11px] font-bold text-gray-700 dark:bg-zinc-800 dark:text-zinc-300">{reconciling ? 'Đang chạy...' : 'Đồng bộ'}</button></div>
